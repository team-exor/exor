Contributing to Exor Core
============================

The Exor Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Exor Core project, and is not to be
confused with overall Exor Network Protocol consensus changes.

Whether a pull request is merged into Exor Core rests with the project merge
...
Patches that change Exor consensus rules are considerably more involved than
...
Where a patch set proposes to change the Exor consensus, it must have been
...
The project leader is the release manager for each Exor Core release.
