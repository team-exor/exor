...
RESOURCES += src/qt/exor.qrc src/qt/exor_locale.qrc

TRANSLATIONS += src/qt/locale/exor_bg.ts \
                src/qt/locale/exor_de.ts \
                src/qt/locale/exor_en.ts \
                src/qt/locale/exor_es.ts \
                src/qt/locale/exor_fi.ts \
                src/qt/locale/exor_fr.ts \
                src/qt/locale/exor_it.ts \
                src/qt/locale/exor_ja.ts \
                src/qt/locale/exor_pl.ts \
                src/qt/locale/exor_pt.ts \
                src/qt/locale/exor_ru.ts \
                src/qt/locale/exor_sk.ts \
                src/qt/locale/exor_sv.ts \
                src/qt/locale/exor_vi.ts \
                src/qt/locale/exor_zh_CN.ts \
                src/qt/locale/exor_zh_TW.ts
