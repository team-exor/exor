...
#   c) node1 mines 32 blocks, so now node 0 has 60001exor, node 1 has 4250exor, node2 has none.
#   d) node0 sends 601 exor to node2, in two transactions (301 exor, then 300 exor).
