...
bool CheckProofOfStake(const CBlock block, uint256& hashProofOfStake, std::unique_ptr<CStakeInput>& stake)
{
    ...
    if (tx.IsZerocoinSpend()) {
        ...
        stake = std::unique_ptr<CStakeInput>(new CZExorStake(spend));
    } else {
        ...
        CExorStake* exorInput = new CExorStake();
        exorInput->SetInput(txPrev, txin.prevout.n);
        stake = std::unique_ptr<CStakeInput>(exorInput);
    }
