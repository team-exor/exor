...
string CRPCTable::help(string strCommand) const
{
    ...
    for (map<string, const CRPCCommand*>::const_iterator mi = mapCommands.begin(); mi != mapCommands.end(); ++mi) {
        if (mi->second->category != "zerocoin"  || (mi->second->category == "zerocoin" && Params().ZeroCoinEnabled()))
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Exor features */
        {"exor", "masternode", &masternode, true, true, false},
        {"exor", "listmasternodes", &listmasternodes, true, true, false},
        {"exor", "getmasternodecount", &getmasternodecount, true, true, false},
        {"exor", "masternodeconnect", &masternodeconnect, true, true, false},
        {"exor", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"exor", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"exor", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"exor", "masternodecurrent", &masternodecurrent, true, true, false},
        {"exor", "masternodedebug", &masternodedebug, true, true, false},
        {"exor", "startmasternode", &startmasternode, true, true, false},
        {"exor", "createmasternodekey", &createmasternodekey, true, true, false},
        {"exor", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"exor", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"exor", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"exor", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"exor", "getmasternodescores", &getmasternodescores, true, true, false},
        {"exor", "mnbudget", &mnbudget, true, true, false},
        {"exor", "preparebudget", &preparebudget, true, true, false},
        {"exor", "submitbudget", &submitbudget, true, true, false},
        {"exor", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"exor", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"exor", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"exor", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"exor", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"exor", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"exor", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"exor", "checkbudgets", &checkbudgets, true, true, false},
        {"exor", "mnsync", &mnsync, true, true, false},
        {"exor", "spork", &spork, true, true, false},
        {"exor", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzexorseed", &getzexorseed, false, false, true},
        {"zerocoin", "setzexorseed", &setzexorseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzexor", &searchdzexor, false, false, true},
        {"zerocoin", "dzexorstate", &dzexorstate, false, false, true}
...
{
    return "> exor-cli " + methodname + " " + args + "\n";
}
