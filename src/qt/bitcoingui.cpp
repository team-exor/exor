                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Exor Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to an Exor address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and exor: URIs)"));
    ...
    if (Params().ZeroCoinEnabled()) {
        ...
        privacyAction->setStatusTip(tr("Privacy Actions for zEXOR"));
    ...
    aboutAction = new QAction(QIcon(":/icons/help"), tr("&About Exor Core"), this);
    aboutAction->setStatusTip(tr("Show information about Exor Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Exor"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(networkStyle->getAppIcon(), tr("&Show / Hide"), this);
    toggleHideAction->setStatusTip(tr("Show or hide the main Window"));

    encryptWalletAction = new QAction(QIcon(":/icons/lock_centered"), tr("&Encrypt Wallet"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Exor addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify Message"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Exor addresses"));
    bip38ToolAction = new QAction(QIcon(":/icons/bip38"), tr("&BIP38 Tool"), this);
    ...
    openAction = new QAction(QIcon(":/icons/page"), tr("Open &URI"), this);
    openAction->setStatusTip(tr("Open an Exor: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Exor Core help message to get a list with possible Exor command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
		...
		toolbar->widgetForAction(overviewAction)->setObjectName("overviewActionToolButton");
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Exor Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Exor network", "", count));
}
...
{
    QString strTitle = tr("Exor Core"); // default title
