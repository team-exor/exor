 ...
 */
    ...
    typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZEXOR));
    typeWidget->addItem(tr("Masternode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
	if (Params().ZeroCoinEnabled()) {
		typeWidget->addItem(tr("Received EXOR from zEXOR"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
		...
		typeWidget->addItem(tr("Zerocoin Spend, Change in zEXOR"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zExor));
