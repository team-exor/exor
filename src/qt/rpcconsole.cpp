...
const struct {
    ...
    {"cmd-request", ":/icons/debug_in"},
    {"cmd-reply", ":/icons/debug_out"},
    {"cmd-error", ":/icons/quit"},
    {"misc", ":/icons/debugwindow"},
	{"debugwindow", ":/icons/debugwindow"},
    {NULL, NULL}};
                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzEXORPathCustom = GetArg("-zexorbackuppath", "");
    ...
    if(!strzEXORPathCustom.empty()) {
        ui->wallet_customzexorbackuppath->setText(QString::fromStdString(strzEXORPathCustom));
        ui->wallet_customzexorbackuppath_label->setVisible(true);
        ui->wallet_customzexorbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzEXORPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(DEBUG_WINDOW, (tr("Welcome to the Exor RPC console.") + "<br>" +
