...
extern UniValue setzexorseed(const UniValue& params, bool fHelp);
extern UniValue getzexorseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzexor(const UniValue& params, bool fHelp);
extern UniValue dzexorstate(const UniValue& params, bool fHelp);
